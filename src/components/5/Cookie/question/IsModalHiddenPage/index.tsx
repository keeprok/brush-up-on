...
export default function IsModalHiddenPage() {
          ...
          <div className="rounded-lg bg-white p-6 shadow-lg">
            ...
            <div className="flex justify-end gap-2">
              <label htmlFor="modalCheckbox" className="flex items-center gap-2">
                <input type="checkbox" id="modalCheckbox" onChange={handleModalCheckboxChange} />
                오늘 하루 보지 않기
              </label>

              <button onClick={handleClose} className="rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600">
                닫기
              </button>
            </div>
          </div>
